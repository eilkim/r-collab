...
From `salmon_us_annual`, create a line graph with year on x-axis and tot_value on y-axis.  Remember groupings!
...
ggplot(data = salmon_us_annual, aes(x = year, 
  ...
  theme_bw() +
  labs(x = "Year", y = "USD", title = "US Commercial Salmon Value by Year") + 
